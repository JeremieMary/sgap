...
class Inscriptions_model extends CI_Model {
	...
	{
		$this->db->select('cycles.id AS cycle_id, cycles.debut AS cycle_debut, matieres.id AS matiere_id , matieres.nom AS matiere_nom, matieres.niveau, accompagnement.commentaire AS commentaire_general, inscriptions.commentaire AS commentaire_perso');
